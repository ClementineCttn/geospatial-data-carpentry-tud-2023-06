...
![](fig/rmd-04centroids-1.png){fig-align="center"}
...
## `r emo::ji("family")` Better together

If you have a question or want to exchange with R-enthustiastic urbanists, we have a community called Rbanism. You are welcome to join our educational, social and technical events. 


**The next one is actually next Thursday (8th June).
3:30pm-7pm, BK
Room K then Bouwpub.**

## `r emo::ji("pizza")` Better together
Additionally, at the TU-Delft level, there is an initiative called the R-Café, meeting monthly to discuss tools, applications and functions in R, whilst eating pizza and drinking coffee (aka healthy lifestyle). The next one will be dedicated to this workshop, and will happen on Tuesday 20th June at 3pm (no pizza exceptionally...)

https://delft-rcafe.github.io/home/Index.html

![](fig/rcafe.png){fig-align="center"}
